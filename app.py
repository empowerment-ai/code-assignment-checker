...
if __name__ == '__main__':
    st.set_page_config(page_title="Code Checking Assistant")
    st.header('🦜🔗 Code Checking Assistant')
    tab1, tab2, tab3 = st.tabs(["AI Instructions", "Assignment Instructions", "Submission Details"])
